...
<div class="card-deck">
  <div class="card mr-5">
    ...
    <div class="card-body">
      ...
      <a class="btn color-p px-5" href="{{route('ventas.create')}}" role="button">Ir</a>
    </div>
  </div>
  <div class="card mr-5">
    ...
    <div class="card-body">
      ...
      <a class="btn color-p px-5" href="{{route('productos.create')}}" role="button">Ir</a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a class="btn color-p px-5" href="{{route('ventas.index')}}" role="button">Ir</a>
    </div>
  </div>
</div>
</section>
